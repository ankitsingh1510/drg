    ...
    <SafeAreaView edges={[]} style={{ flex: 1, paddingTop: headerHeight }} className="bg-[#FDF5E6] dark:bg-gray-900">
              ...
              <View className="flex-row items-center justify-between">
                <View className="flex-1">
                  <View className="flex-row items-center gap-2">
                    ...
                    <Text className="font-outfit-bold text-xl tracking-tight text-gray-900 dark:text-white">
                      {item.patientName || 'Untitled Session'}
                    </Text>
                  </View>
                  <View className="mt-3 flex-row items-center gap-2">
                    <Phone size={14} color="#9ca3af" />
                    <Text className="font-outfit-medium text-sm text-gray-500 dark:text-gray-400">
      ...
      <View className="absolute bottom-8 left-0 right-0 items-center">
        ...
        >
          ...
          <Text className="ml-3 font-outfit-bold text-xl text-white">New Scribe</Text>
        </Pressable>
      </View>
      ...
      >
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }}>
          <SafeAreaView className="flex-1 bg-[#FDF5E6] dark:bg-gray-900" edges={['bottom', 'left', 'right']}>
            ...
            >
              <Text className="font-outfit-bold text-2xl text-gray-900 dark:text-white">New Session</Text>
              {!showDashboard && (
                <Pressable
                ...
                <View className="flex-1 py-4">
                  {!showDashboard ? (
                    <View className="space-y-6">
                      <View>
                        <Text className="mb-2 ml-1 font-outfit-bold text-sm uppercase tracking-widest text-gray-400">
                          Patient Name
                        </Text>
                      ...
                      <View className="mt-8">
                        ...
                        >
                          ...
                          <Text className="ml-3 font-outfit-semibold text-base text-gray-700 dark:text-gray-300">
                      ...
                      <View className="mt-12 items-center">
                        ...
                        >
                          <Mic size={24} color="white" />
                          <Text className="ml-3 font-outfit-bold text-xl text-white">Start Recording</Text>
                        </Pressable>
                      </View>
                    </View>
                  ) : (
                    <View className="flex-1 items-center justify-center">
                      ...
                      <Text className="font-outfit-bold text-3xl text-gray-900 dark:text-white">
                      ...
                      <View className="mt-24 w-full px-6">
                          ...
                          >
                            {isPaused ? (
                              <>
                                ...
                                <Text className="ml-2 font-outfit-bold text-lg text-white">Resume Recording</Text>
                              </>
                            ) : (
                              <>
                                <Pause size={20} color="#6b7280" />
                                <Text className="ml-2 font-outfit-bold text-lg text-gray-600 dark:text-gray-300">
                                  Pause Recording
                                </Text>
                              </>
                            )}
                        ...
                        <View className="mt-4">
                          ...
                          >
                            ...
                            <Text className="ml-2 font-outfit-bold text-lg text-white">Stop and Save</Text>
                          </Pressable>
                        </View>
                      </View>
                    </View>
