    ...
    <SafeAreaView className="flex-1 bg-[#FDF5E6] dark:bg-[#0B1929]">
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View className="flex-row items-center justify-between px-6 py-4">
          <AppText className="text-base font-semibold text-gray-800 dark:text-white">Patient Name</AppText>
          <AppText className="text-[13px] font-medium text-gray-500 dark:text-[#8BA5C0]">Age: 52 | Male</AppText>
        </View>
        ...
        <View className="mb-6 flex-row gap-2 px-5">
          <TouchableOpacity className="flex-row items-center gap-1.5 rounded-lg border border-gray-200 px-3 py-1.5 dark:border-[#1A3050]">
            ...
            <AppText className="text-[13px] font-medium text-gray-500 dark:text-[#8BA5C0]">Date</AppText>
          </TouchableOpacity>
          <TouchableOpacity className="flex-row items-center gap-1.5 rounded-lg border border-gray-200 px-3 py-1.5 dark:border-[#1A3050]">
            <AppText className="text-[13px] font-medium text-gray-500 dark:text-[#8BA5C0]">Sort by</AppText>
            <ChevronDown size={14} color={colors.textSecondary} />
          </TouchableOpacity>
          <TouchableOpacity className="flex-row items-center gap-1.5 rounded-lg border border-gray-200 px-3 py-1.5 dark:border-[#1A3050]">
            <AppText className="text-[13px] font-medium text-gray-500 dark:text-[#8BA5C0]">Report type</AppText>
            <ChevronDown size={14} color={colors.textSecondary} />
          </TouchableOpacity>
        </View>
              ...
              <View key={item.id} className="flex-row">
                ...
                <View className="flex-1 pl-2">
                  <View className="mb-2.5 flex-row items-center gap-2.5">
                    <AppText className="text-[13px] font-semibold text-gray-800 dark:text-white">{item.date}</AppText>
                    <View className="rounded bg-blue-100 px-2 py-0.5">
                      <AppText className="text-[10px] font-bold text-blue-600">{getBadgeLabel(item.badgeType)}</AppText>
                    </View>
                  </View>
                  ...
                  >
                    ...
                    <View className="flex-row items-center gap-2.5 bg-gray-50 p-3 dark:bg-[#1A3050]">
                      ...
                      <View>
                        <AppText className="text-[10px] font-bold tracking-widest text-[#9CA3AF]">PROVIDER</AppText>
                        <AppText className="mt-0.5 text-[13px] font-medium text-gray-800 dark:text-white">
                          {item.provider}
                        </AppText>
                      </View>
                    </View>
                    ...
                    <View className="p-3.5">
                      <AppText className="mb-1.5 text-[10px] font-bold tracking-widest text-[#9CA3AF]">
                        AI SUMMARY
                      </AppText>
