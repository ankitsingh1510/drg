    ...
    <Modal visible={visible} transparent animationType="fade">
      <View className="flex-1 items-center justify-center bg-black/50">
        <View className="mx-5 w-full max-w-md rounded-xl bg-white p-6 shadow-lg dark:bg-gray-800">
          <Text className="mb-2 text-xl font-outfit-semibold text-gray-800 dark:text-gray-100">Confirm 2FA Change</Text>
          ...
          >
            <Text className="text-center font-outfit-semibold text-white">Continue</Text>
          </TouchableOpacity>
        </View>
      </View>
    </Modal>
