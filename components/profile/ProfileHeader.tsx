...
export default function ProfileHeader({ firstName, lastName, organizationName }: ProfileHeaderProps) {
  ...
  return (
    <View className="justify-left mb-6 flex-row items-center gap-6 rounded-xl bg-white p-6 shadow-md dark:bg-gray-800">
      ...
      <View>
        <Text className="mt-3 text-xl font-semibold text-gray-800 dark:text-gray-100">
          {firstName} {lastName}
        </Text>
