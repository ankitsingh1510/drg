    ...
    >
      <View className="mb-[14px] flex-row items-center justify-between">
        <View className="flex-row items-center">
          <AppText className="text-[15px] font-semibold" style={{ color: isDark ? '#f3f4f6' : '#1f2937' }}>
      ...
      >
        ...
        <View className="flex-1">
          <AppText className="text-base font-semibold leading-[22px]" style={{ color: isDark ? '#f3f4f6' : '#1f2937' }}>
            {currentTip.tip}
          </AppText>
        </View>
      </Animated.View>
